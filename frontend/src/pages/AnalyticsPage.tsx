...
export function AnalyticsPage() {
  ...
  return (
    <div className={pageWrapper}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className={sectionCard}>
          <h3 className="mb-2 text-sm font-medium">Best dishes</h3>
          {metrics.bestDishes.length === 0 ? (
            ...
            <table className="w-full text-sm">
              <thead className="border-b text-left text-muted-foreground">
                <tr>
                  <th className="py-2 font-medium">Dish</th>
        ...
        <div className={sectionCard}>
          <h3 className="mb-2 text-sm font-medium">Worst dishes</h3>
        ...
        <div className={sectionCard}>
          <h3 className="mb-2 text-sm font-medium">Staff performance</h3>
            ...
            <table className="w-full text-sm">
              <thead className="border-b text-left text-muted-foreground">
                <tr>
                  ...
                  <th className="py-2 font-medium">Items Served</th>
                  <th className="py-2 font-medium">Closed Orders</th>
                  <th className="py-2 font-medium text-right">Avg Turnover (min)</th>
                </tr>
              </thead>
              <tbody>
                {metrics.staffPerformance.map((s) => (
                  <tr key={s.staff} className="border-b last:border-0">
                    ...
                    <td className="py-2">{s.servedItems}</td>
                    <td className="py-2">{s.closedOrders}</td>
                    <td className="py-2 text-right">{Math.round(s.avgTurnoverMinutes)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className={sectionCard}>
          <h3 className="mb-2 text-sm font-medium">Kitchen efficiency</h3>
            ...
            <table className="w-full text-sm">
              <thead className="border-b text-left text-muted-foreground">
                <tr>
                  ...
                  <th className="py-2 font-medium text-right">Avg Prep (min)</th>
                </tr>
              </thead>
              <tbody>
                {metrics.kitchenEfficiency.map((k) => (
                  <tr key={k.kitchen} className="border-b last:border-0">
                    <td className="py-2">{k.kitchen}</td>
                    <td className="py-2">{k.items}</td>
                    <td className="py-2 text-right">{Math.round(k.avgPrepMinutes)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className={sectionCard}>
          <h3 className="mb-2 text-sm font-medium">Table turnover</h3>
            ...
            <table className="w-full text-sm">
              <thead className="border-b text-left text-muted-foreground">
                <tr>
                  ...
                  <th className="py-2 font-medium text-right">Avg Duration (min)</th>
                </tr>
              </thead>
              <tbody>
                {metrics.tableTurnover.map((t) => (
                  <tr key={t.table} className="border-b last:border-0">
                    ...
                    <td className="py-2">{t.floor}</td>
                    <td className="py-2">{t.orders}</td>
                    <td className="py-2 text-right">{Math.round(t.avgDiningMinutes)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className={sectionCard}>
          <h3 className="mb-2 text-sm font-medium">Voids &amp; discounts by staff</h3>
          {metrics.voidsAndDiscounts.length === 0 ? (
            ...
            <table className="w-full text-sm">
              <thead className="border-b text-left text-muted-foreground">
                <tr>
                  <th className="py-2 font-medium">Staff</th>
                  <th className="py-2 font-medium">Cancelled Items</th>
                  <th className="py-2 font-medium text-right">Discount Value</th>
                </tr>
              </thead>
              <tbody>
                {metrics.voidsAndDiscounts.map((v) => (
                  <tr key={v.staff} className="border-b last:border-0">
                    <td className="py-2">{v.staff}</td>
                    <td className="py-2">{v.cancelledItems}</td>
                    <td className="py-2 text-right">{formatCurrency(v.discountValue)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
